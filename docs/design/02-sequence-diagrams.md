...
sequenceDiagram
    ...
    상품 상세 조회 API->>상품: 상품 상세 요청 (상품 ID)
    상품->>상품DB: 상품 ID로 상품 상세 정보 조회
...
sequenceDiagram
    ...
    브랜드 조회 API->>브랜드: 브랜드 정보 요청 (브랜드 ID)
    브랜드->>브랜드DB: 브랜드 ID로 브랜드 정보 조회
...
participant 상품DB
    ...
    alt 사용자나 상품이 존재하지 않을 경우
        ...
        좋아요->>좋아요DB: 좋아요 데이터 저장
        좋아요->>상품DB: 해당 상품 좋아요 수 증가
    end
```
...
participant 상품DB
    ...
    alt 사용자나 상품이 존재하지 않을 경우
        ...
        좋아요->>좋아요DB: 좋아요 데이터 삭제
        좋아요->>상품DB: 해당 상품 좋아요 수 감소
    end
```
...
participant 좋아요DB
    ...
    alt 사용자가 존재하지 않을 경우
        ...
        회원-->>좋아요: 사용자 존재함
        좋아요->>좋아요DB: 좋아요 한 상품 목록 조회
        좋아요DB-->>좋아요: 좋아요 한 상품 목록 반환
